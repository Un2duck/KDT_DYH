...
# 모델 호출
MODEL_FILE = r'C:\Users\KDP-50\OneDrive\바탕 화면\KDT_DYH\11.HTML,CSS,JAVA\Project\models\fruit_loss(8.6757)_score(0.9410)'
        ...
        <html lang="en">
         ...
         <body bgcolor="pink">
            <form method="POST" enctype="multipart/form-data">
                <div>
                    file : <input type="file" id="imageInput" name="files" accept="image/*">
                </div>
...
image = form.getvalue("files", None)
...
if image:
    result = predict_model(fruits_Model, f'fruits_images\{filename}')
    msg = f"예측 결과: {result}"
    print(msg)
else:
    msg = '이미지를 선택하세요.'
