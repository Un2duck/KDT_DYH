...
FROM nobel 
WHERE category='Peace' and year between 1910 and 2010 order by year asc;
...
# 13번. 수상자의 국가가 Europe, North America, null이 아닌 정보 출력 
SELECT * FROM nobel
